...
| ------- | ----------- | ---------- |
| [Finance Tracker Web App](https://github.com/puskr/finance-tracker-app) <br> ![Finance Tracker Web App](https://github.com/puskr/finance-tracker-app/blob/main/static/dashboard_preview.png) | This is a personal finance tracking web application built with Flask and PostgreSQL. Users can register, log in, input their income and expenses, and view dashboards showing financial summaries. Features include savings goal tracking, income-vs-hours analysis, and categorized expense insights. Visuals are created using Power BI and integrated into the app. | Flask, PostgreSQL, Power BI |
